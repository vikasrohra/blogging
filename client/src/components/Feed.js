...
const FeedCards = () => {
  ...
  return [1, 2, 3, 4, 5].map((feed, index) => {
    return (
      <>
        ...
        >
          <Box sx={{ display: "flex", flexDirection: "column" }}>
            ...
            <Box sx={{ display: "flex", mt: 2 }}>
              ...
              <Box sx={{ display: "flex", flexDirection: "column" }}>
                <Box>
                  <Typography variant="h6">Introduction to Node.js</Typography>
                </Box>
                <Box>
                  <Typography variant="body2" sx={{ color: "#aaa" }}>
                    What is Node.js? Node.js is a JavaScript runtime that allows
                    developers to run JavaScript outside of the web browser. It
                    is built on top of the V8 JavaScript engine, which is the
                    same engine used by the Google Chrome web browser to execute
                    JavaScript...
                  </Typography>
                </Box>
              </Box>
